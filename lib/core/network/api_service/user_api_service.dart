...
class UserApiService {
  UserApiService({ApiClient? client}) : _client = client ?? ApiClient(ApiEndpoints.baseUrl);
  ...
  Future<Map<String, dynamic>> updateProfile({
    ...
    final Response response = await _client.patch(ApiEndpoints.updateProfile, data: formData);
    return Map<String, dynamic>.from(response.data as Map);
  }
